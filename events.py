...
class Event(SqlAlchemyBase):
    ...
    Etitle_of_event = sqlalchemy.Column(sqlalchemy.Text)
    Edate_of_start_event = sqlalchemy.Column(sqlalchemy.Date)
    Edate_of_finish_event = sqlalchemy.Column(sqlalchemy.Date)
    Estatus_of_speciality = sqlalchemy.Column(sqlalchemy.Text, default='all')
    Estatus_of_school = sqlalchemy.Column(sqlalchemy.Text, default='all')
    ...
    Edescription = sqlalchemy.Column(sqlalchemy.Text, nullable=True)